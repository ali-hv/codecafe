...
from .views import courses_list, course_detail, register_free_course, search_courses

app_name = 'courses'

urlpatterns = [
    path('', courses_list, name="courses_list"),
    path('register/<int:course_id>', register_free_course, name='register_free_course'),
